...
* chore: support Laravel 13.x by @laravel-shift in https://github.com/red-explosion/laravel-sqids/pull/27

**Full Changelog**: https://github.com/red-explosion/laravel-sqids/compare/v2.0.0...v2.1.0

## v2.0.0 - 2026-02-27

### What's Changed

* chore: bump to sqids ^0.5 by @ziming in https://github.com/red-explosion/laravel-sqids/pull/16
* feat: validate sqid when decoding by @bensherred in https://github.com/red-explosion/laravel-sqids/pull/25
* feat: add sqid exists validation rule by @bensherred in https://github.com/red-explosion/laravel-sqids/pull/26

### New Contributors

* @ziming made their first contribution in https://github.com/red-explosion/laravel-sqids/pull/16

**Full Changelog**: https://github.com/red-explosion/laravel-sqids/compare/v1.3.1...v2.0.0
